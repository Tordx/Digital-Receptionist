  ...
  export const AdminFeedBackScreen = () => {
    ...
    const handleDateSelect = async (date) => {
      ...
      try {
        ...
        const filteredData = modifiedArr.filter(item => item.FeedbackorSuggestion === 'Feedback');
  ...
  <ImageBackground style={styles.container} source={require('../../../Assets/Img/Background_image.png')}>
    ...
    <ScrollView
     refreshControl={
      ...
      <View style={[styles.status, { backgroundColor: 'blue' }]}>
        <Text style={styles.text}>FeedBack</Text>
      </View>
      <FlatList
        showsHorizontalScrollIndicator={false}
        data={feedback.filter((item) => item.Department.includes(searchQuery))}
