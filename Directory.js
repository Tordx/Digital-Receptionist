   ...
   <Provider store={store}>
        <NavigationContainer>
            <Stack.Navigator initialRouteName='IntialRoutingScreen'>
                ...
                <Stack.Screen name = 'IdleScreen' component={IdleScreen} options = {{ headerShown: false }} />
                ...
                <Stack.Screen name = 'FacultyConfig' component={FacultyConfig} options = {{ headerShown: false }} />
